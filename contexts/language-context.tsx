...
const translations = {
  vi: {
    ...
    "admin.sidebar.subscriptions": "Quản lý gói dịch vụ",
    "admin.sidebar.analytics": "Báo cáo & Thống kê",
    "admin.sidebar.branding": "Quản lý Thương hiệu",
    "admin.sidebar.security": "Bảo mật",
    "admin.sidebar.settings": "Cài đặt hệ thống",
    "admin.sidebar.content": "Quản lý nội dung",
    "admin.sidebar.homepage": "Trang chủ",
    "admin.sidebar.homepage.overview": "Tổng quan",
    "admin.sidebar.homepage.hero": "Hero Section",
    "admin.sidebar.homepage.features": "Tính năng nổi bật",
    "admin.sidebar.homepage.why_choose": "Tại sao chọn chúng tôi",
    "admin.sidebar.homepage.cta": "CTA - Sẵn sàng bắt đầu",
    "admin.sidebar.homepage.footer": "Footer",
    "admin.sidebar.content.about": "Về chúng tôi",
    "admin.sidebar.content.services": "Dịch vụ",
    "admin.sidebar.content.contact": "Liên hệ",
    "admin.sidebar.content.register": "Đăng ký",
    "admin.sidebar.content.login": "Đăng nhập",

    // Admin Dashboard
    "admin.dashboard.title": "Dashboard Quản trị",
    "admin.dashboard.subtitle": "Tổng quan hệ thống ConstructVN",
    "admin.dashboard.login_title": "Đăng nhập Admin",
    "admin.dashboard.login_subtitle": "Truy cập hệ thống quản trị ConstructVN",
    "admin.dashboard.username": "Tài khoản",
    "admin.dashboard.password": "Mật khẩu",
    "admin.dashboard.username_placeholder": "Nhập tài khoản",
    "admin.dashboard.password_placeholder": "Nhập mật khẩu",
    "admin.dashboard.login_button": "Đăng nhập",
    "admin.dashboard.login_error": "Tài khoản hoặc mật khẩu không đúng",
    "admin.dashboard.total_users": "Tổng người dùng",
    "admin.dashboard.monthly_revenue": "Doanh thu tháng",
    "admin.dashboard.subscriptions": "Gói đăng ký",
    "admin.dashboard.active_users": "Người dùng hoạt động",
    "admin.dashboard.vs_last_month": "so với tháng trước",
    "admin.dashboard.revenue_chart": "Doanh thu theo tháng",
    "admin.dashboard.revenue_chart_placeholder": "Biểu đồ doanh thu",
    "admin.dashboard.new_users": "Người dùng mới",
    "admin.dashboard.user_placeholder": "Người dùng",

    // Admin Users
    "admin.users.title": "Quản lý người dùng",
    "admin.users.subtitle": "Quản lý tài khoản người dùng hệ thống",
    "admin.users.add_user": "Thêm người dùng",
    "admin.users.total_users": "Tổng người dùng",
    "admin.users.active_users": "Đang hoạt động",
    "admin.users.inactive_users": "Không hoạt động",
    "admin.users.paid_users": "Người dùng trả phí",
    "admin.users.user_list": "Danh sách Người dùng",
    "admin.users.user_list_desc": "Quản lý và theo dõi thông tin người dùng",
    "admin.users.search_placeholder": "Tìm kiếm theo tên hoặc email...",
    "admin.users.user": "Người dùng",
    "admin.users.service_package": "Gói dịch vụ",
    "admin.users.status": "Trạng thái",
    "admin.users.join_date": "Ngày tham gia",
    "admin.users.last_login": "Đăng nhập cuối",
    "admin.users.actions": "Thao tác",
    "admin.users.edit_user": "Chỉnh sửa người dùng",
    "admin.users.edit_user_desc": "Cập nhật thông tin và trạng thái người dùng",
    "admin.users.name": "Tên",
    "admin.users.email": "Email",
    "admin.users.cancel": "Hủy",
    "admin.users.save_changes": "Lưu thay đổi",
    "admin.users.delete_confirm": "Bạn có chắc chắn muốn xóa người dùng này?",
    "admin.users.status_active": "Hoạt động",
    "admin.users.status_inactive": "Không hoạt động",
    "admin.users.status_suspended": "Tạm khóa",
    "admin.users.status_unknown": "Không xác định",
    "admin.users.vs_last_month": "so với tháng trước",
    "admin.users.vs_last_week": "so với tuần trước",

    // Admin Subscriptions
    "admin.subscriptions.title": "Quản lý gói dịch vụ",
    "admin.subscriptions.subtitle": "Quản lý các gói dịch vụ và đăng ký",
    "admin.subscriptions.overview": "Tổng quan",
    "admin.subscriptions.plans": "Gói dịch vụ",
    "admin.subscriptions.total_revenue": "Tổng doanh thu",
    "admin.subscriptions.active_subscriptions": "Subscription hoạt động",
    "admin.subscriptions.expired_subscriptions": "Subscription hết hạn",
    "admin.subscriptions.renewal_rate": "Tỷ lệ gia hạn",
    "admin.subscriptions.vs_last_month": "so với tháng trước",
    "admin.subscriptions.vs_last_week": "so với tuần trước",
    "admin.subscriptions.all": "Tất cả",
    "admin.subscriptions.active": "Đang hoạt động",
    "admin.subscriptions.expired": "Hết hạn",
    "admin.subscriptions.cancelled": "Đã hủy",
    "admin.subscriptions.subscription_list": "Danh sách Subscription",
    "admin.subscriptions.manage_all_subscriptions": "Quản lý tất cả subscription của người dùng",
    "admin.subscriptions.search_placeholder": "Tìm kiếm theo tên, email hoặc gói...",
    "admin.subscriptions.user": "Người dùng",
    "admin.subscriptions.service_package": "Gói dịch vụ",
    "admin.subscriptions.status": "Trạng thái",
    "admin.subscriptions.start_date": "Ngày bắt đầu",
    "admin.subscriptions.end_date": "Ngày hết hạn",
    "admin.subscriptions.amount": "Số tiền",
    "admin.subscriptions.payment": "Thanh toán",
    "admin.subscriptions.status_active": "Đang hoạt động",
    "admin.subscriptions.status_expired": "Hết hạn",
    "admin.subscriptions.status_cancelled": "Đã hủy",
    "admin.subscriptions.status_unknown": "Không xác định",

    // Admin Analytics
    "admin.analytics.title": "Báo cáo & Thống kê",
    "admin.analytics.subtitle": "Phân tích dữ liệu và báo cáo hệ thống",
    "admin.analytics.overview": "Tổng quan",
    "admin.analytics.reports": "Báo cáo",
    "admin.analytics.charts": "Biểu đồ",
    "admin.analytics.export": "Xuất dữ liệu",

    // Admin Branding
    "admin.branding.title": "Quản lý Thương hiệu",
    "admin.branding.subtitle": "Cài đặt thương hiệu và giao diện",
    "admin.branding.logo": "Logo",
    "admin.branding.colors": "Màu sắc",
    "admin.branding.fonts": "Phông chữ",
    "admin.branding.theme": "Giao diện",

    // Admin Security
    "admin.security.title": "Bảo mật",
    "admin.security.subtitle": "Cài đặt bảo mật hệ thống",
    "admin.security.password_policy": "Chính sách mật khẩu",
    "admin.security.two_factor": "Xác thực 2 bước",
    "admin.security.login_attempts": "Giới hạn đăng nhập",
    "admin.security.session_timeout": "Thời gian phiên",

    // Admin Settings
    "admin.settings.title": "Cài đặt hệ thống",
    "admin.settings.subtitle": "Cấu hình chung của hệ thống",
    ...
    "agentManagement.reports": "Báo cáo",
  ...
  en: {
    ...
    "admin.sidebar.subscriptions": "Service Packages",
    "admin.sidebar.analytics": "Reports & Analytics",
    "admin.sidebar.branding": "Brand Management",
    "admin.sidebar.security": "Security",
    "admin.sidebar.settings": "System Settings",
    "admin.sidebar.content": "Content Management",
    "admin.sidebar.homepage": "Homepage",
    "admin.sidebar.homepage.overview": "Overview",
    "admin.sidebar.homepage.hero": "Hero Section",
    "admin.sidebar.homepage.features": "Features",
    "admin.sidebar.homepage.why_choose": "Why Choose Us",
    "admin.sidebar.homepage.cta": "CTA - Get Started",
    "admin.sidebar.homepage.footer": "Footer",
    "admin.sidebar.content.about": "About Us",
    "admin.sidebar.content.services": "Services",
    "admin.sidebar.content.contact": "Contact",
    "admin.sidebar.content.register": "Register",
    "admin.sidebar.content.login": "Login",

    // Admin Dashboard
    "admin.dashboard.title": "Admin Dashboard",
    "admin.dashboard.subtitle": "ConstructVN System Overview",
    "admin.dashboard.login_title": "Admin Login",
    "admin.dashboard.login_subtitle": "Access ConstructVN Management System",
    "admin.dashboard.username": "Username",
    "admin.dashboard.password": "Password",
    "admin.dashboard.username_placeholder": "Enter username",
    "admin.dashboard.password_placeholder": "Enter password",
    "admin.dashboard.login_button": "Login",
    "admin.dashboard.login_error": "Invalid username or password",
    "admin.dashboard.total_users": "Total Users",
    "admin.dashboard.monthly_revenue": "Monthly Revenue",
    "admin.dashboard.subscriptions": "Subscriptions",
    "admin.dashboard.active_users": "Active Users",
    "admin.dashboard.vs_last_month": "vs last month",
    "admin.dashboard.revenue_chart": "Monthly Revenue",
    "admin.dashboard.revenue_chart_placeholder": "Revenue Chart",
    "admin.dashboard.new_users": "New Users",
    "admin.dashboard.user_placeholder": "User",
    ...
    "admin.users.active_users": "Active",
    "admin.users.inactive_users": "Inactive",
    "admin.users.paid_users": "Paid Users",
    "admin.users.user_list": "User List",
    "admin.users.user_list_desc": "Manage and monitor user information",
    "admin.users.search_placeholder": "Search by name or email...",
    "admin.users.user": "User",
    "admin.users.service_package": "Service Package",
    "admin.users.status": "Status",
    "admin.users.join_date": "Join Date",
    "admin.users.last_login": "Last Login",
    "admin.users.actions": "Actions",
    "admin.users.edit_user": "Edit User",
    "admin.users.edit_user_desc": "Update user information and status",
    ...
    "admin.users.status_unknown": "Unknown",
    "admin.users.vs_last_month": "vs last month",
    "admin.users.vs_last_week": "vs last week",

    // Admin Subscriptions
    "admin.subscriptions.title": "Service Package Management",
    "admin.subscriptions.subtitle": "Manage service packages and subscriptions",
    "admin.subscriptions.overview": "Overview",
    "admin.subscriptions.plans": "Service Plans",
    "admin.subscriptions.total_revenue": "Total Revenue",
    "admin.subscriptions.active_subscriptions": "Active Subscriptions",
    "admin.subscriptions.expired_subscriptions": "Expired Subscriptions",
    "admin.subscriptions.renewal_rate": "Renewal Rate",
    "admin.subscriptions.vs_last_month": "vs last month",
    "admin.subscriptions.vs_last_week": "vs last week",
    "admin.subscriptions.all": "All",
    "admin.subscriptions.active": "Active",
    "admin.subscriptions.expired": "Expired",
    "admin.subscriptions.cancelled": "Cancelled",
    "admin.subscriptions.subscription_list": "Subscription List",
    "admin.subscriptions.manage_all_subscriptions": "Manage all user subscriptions",
    "admin.subscriptions.search_placeholder": "Search by name, email or package...",
    "admin.subscriptions.user": "User",
    "admin.subscriptions.service_package": "Service Package",
    "admin.subscriptions.status": "Status",
    "admin.subscriptions.start_date": "Start Date",
    "admin.subscriptions.end_date": "End Date",
    "admin.subscriptions.amount": "Amount",
    "admin.subscriptions.payment": "Payment",
    "admin.subscriptions.status_active": "Active",
    "admin.subscriptions.status_expired": "Expired",
    "admin.subscriptions.status_cancelled": "Cancelled",
    "admin.subscriptions.status_unknown": "Unknown",

    // Admin Analytics
    "admin.analytics.title": "Reports & Analytics",
    "admin.analytics.subtitle": "Data analysis and system reports",
    "admin.analytics.overview": "Overview",
    "admin.analytics.reports": "Reports",
    "admin.analytics.charts": "Charts",
    "admin.analytics.export": "Export Data",

    // Admin Branding
    "admin.branding.title": "Brand Management",
    "admin.branding.subtitle": "Brand and interface settings",
    "admin.branding.logo": "Logo",
    ...
    "admin.security.subtitle": "System security settings",
    "admin.security.password_policy": "Password Policy",
    "admin.security.two_factor": "Two-Factor Authentication",
    "admin.security.login_attempts": "Login Attempts Limit",
    "admin.security.session_timeout": "Session Timeout",

    // Admin Settings
    "admin.settings.title": "System Settings",
    "admin.settings.subtitle": "General system configuration",
